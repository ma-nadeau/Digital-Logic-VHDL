...
-- Vhdl Test Bench template for design  :  jatin_patel_comparator
-- 
...
ENTITY jatin_patel_comparator_vhd_tst IS
END jatin_patel_comparator_vhd_tst;
ARCHITECTURE jatin_patel_comparator_arch OF jatin_patel_comparator_vhd_tst IS
-- constants                                                 
-- signals                                                   
...
COMPONENT jatin_patel_comparator
	PORT (
...
WAIT;                                                        
END PROCESS always;                                          
END jatin_patel_comparator_arch;
